class AppLanguage {
  ...
  //---------------otp------------------------------------------
  static const otpVerficationText = ["OTP Verification"];
  static const sentOtpText = [
    "We sent an sms with a 6-digit code to your registered phone number. Please enter it sowe can be sure that this phone number belongs to you."
  ];
  static const didnotReciveOtpText = ["Didn’t recieve the OTP? "];
  static const resendText = ["Resend"];
  static const changePhoneNumberText = ["Change Phone Number"];
  static const verifyButtonText = ["Verify"];
  //---------------Sign up---------------------------------------------
  static const createYourAccountText = ["Create your account"];
  ...
  static const adminAssignedText = [
    "Admin has assigned you a car wash task. Check the details and get started!"
  ];

  //------------------footer-----------------------
  static const exploreText = ["Explore"];
  static const myTripText = ["My Trip"];
  static const inboxText = ["Inbox"];
  static const favouritesText = ["Favourites"];
  ...
  static const reasonText = ["Reason for delete an account"];
  ...
  static const sureDeleteText = [
    "Are you sure you want to delete your account?"
  ];
  static const sureLogOutText = [
    "Are you sure you want to log out? You'll need to sign back in to access your car wash services and booking history.."
  ];
  //--------------- Profile-----------------------------------------
  static const audioCallText = ["Audio Call"];
  static const postsText = ["Posts"];
  static const followersText = ["Followers"];
  static const followingText = ["Following"];
  static const favoriteInfluencerText = ["favorite influencer"];
  ...
  //----------------order--------------------
  static const myorderText = ["My Order"];
  static const grandTotalText = ["Grand Total"];
  static const deliveryChargesText = ["Delivery Charges"];
  static const orderText = ["Order"];
  static const itemTotalText = ["Item total"];
  static const taxText = ["Tax"];
  static const blockText = ["Block"];
  static const cancelText = ["Cancel"];
  static const activeNowText = ["Active now"];
  static const customerText = ["Customer"];
  ...
  static const recievedText = ["Recieved"];
  static const acceptedText = ["Accepted"];
  static const preparedText = ["Prepared"];
  static const completedText = ["Completed"];
  static const pickupText = ["Pickup"];
  static const orderDetailsText = ["Order Details"];
  static const addressDetailsText = ["Address Details"];
  static const saladText = ["salad"];
  static const fastFoodText = ["Spicy fast food"];
  static const houseText = ["House"];

  //----------------Booking history-------------------
  static const rebookText = ["Rebook"];
  //----------------Inbox-------------------
  static const chatText = ["Chat"];

  //==================piyush (19-02-2025)===============
  //==============beach=================
  static const availabletext = ["Available"];
  static const listtext = ["List"];
  static const gridtext = ["Grid"];
  static const maptext = ["Map"];
  static const filtertext = ["Filter"];
  static const sorttext = ["Sort"];
  static const memberstext = ["Members"];
  static const kwdtext = ["KWD/"];
  static const hourtext = ["Hour"];

  //================bookings==================
  static const bookingsText = ["Bookings"];
  static const startTimeText = ["Start Time"];
  static const bookingHoursText = ["Booking Hours"];
  static const ongoingText = ["Ongoing"];
  static const statuText = ["Status"];

  //==============review=============

  static const reviewText = ["Review"];
  static const addReviewText = ["Add Review"];
  static const reviewByText = ["Review by"];

  //===============rate now================
  static const rateNowText = ["Rate Now"];
  static const totalRatingsText = ["Total Ratings"];
  static const ratingText = ["Rating:"];
  static const commentsText = ["Comments:"];

  //==============add-ons=============
  static const addonsText = ["Add-ons"];
  static const viewDetailsText = ["View Details"];
  static const equipmentText = ["Equipment"];
  static const foodText = ["Food"];
  static const entertainmentText = ["Entertainment"];
  static const payableAmountText = ["Payable Amount"];
  static const continueText = ["Continue"];

  //==================details=================
  static const detailsText = ["Details"];
  static const reviewsText = ["Reviews"];
  static const pricehrText = ["Price/Hr"];
  static const descriptionsText = ["Description"];
  static const cancellationPolicyText = ["Cancellation policy"];
  static const amenitiesText = ["Amenities"];
  static const companyProfileText = ["Company Profile"];
  static const bookNowText = ["Book Now"];
  static const selectFexibleText = [
    "Select flexible booking hours to match your schedule, with real-time availability and cost calculation"
  ];
  static const selectHoursText = ["Select Hours"];
  static const startTimeForBookingText = [
    "Choose the start time for your booking to plan your experience conveniently"
  ];
  static const agreeText = [
    "By booking, you agree to follow safety rules, use the boat responsibly, and cover any damages or violation"
  ];
  static const yachtSizeText = ["Yacht size: "];
  static const yachtCapacityText = ["Yacht capacity: "];
  static const yachtText = ["yacht capacity: "];
  static const facilitiesText = ["Facilities: "];
  ...
  //===================booking details================
  static const bookingDetailsText = ["Booking Details"];
  static const locationAddressText = ["Location Address"];
  static const bookingDateText = ["Booking Date & Start Time"];
  static const changeText = ["Change"];
  static const priceText = ["Price : "];
  static const captainFeesText = ["Captain Fees"];
  static const paynowText = ["Pay Now"];
  static const qtyText = ["Qty :"];
...
//--------------------------------------07/06/2025-------------------------------------------
  ...
  static const premiumText = ["Premium"];
  static const groupText = ["Group"];
